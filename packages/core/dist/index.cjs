...
__export(index_exports, {
  ...
  Badge: () => import_react5.Badge,
  Box: () => import_react5.Box,
  Button: () => Button,
  Card: () => import_react5.Card,
  Code: () => import_react5.Code,
  CodeBlock: () => CodeBlock,
  Flex: () => import_react5.Flex,
  Grid: () => import_react5.Grid,
  HStack: () => import_react5.HStack,
  Heading: () => import_react5.Heading,
  Separator: () => import_react5.Separator,
  Stack: () => import_react5.Stack,
  Text: () => import_react5.Text,
  VStack: () => import_react5.VStack,
  system: () => system
});
...
var import_tokens = require("@agentic-ds/tokens");
var buttonRecipe = (0, import_react.defineRecipe)({
  base: {
    display: "inline-flex",
    alignItems: "center",
...
var config = (0, import_react.defineConfig)({
  ...
  theme: {
    ...
    tokens: {
      fonts: {
        mono: { value: import_tokens.fonts.mono },
        sans: { value: import_tokens.fonts.sans },
        heading: { value: import_tokens.fonts.sans },
        body: { value: import_tokens.fonts.sans }
      }
    },
    semanticTokens: {
      colors: {
...
var system = (0, import_react.createSystem)(import_react.defaultConfig, config);
...
function AgenticProvider({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { "data-agentic-ds": "", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: keyframes }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react2.ChakraProvider, { value: system, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
var ButtonEl = (0, import_react3.chakra)("button");
var baseStyles = {
  display: "inline-flex",
  alignItems: "center",
  justifyContent: "center",
...
function LoadingDots() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react3.Box, { as: "span", display: "inline-flex", alignItems: "center", gap: "3px", "aria-hidden": true, children: [0, 1, 2].map((i) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_react3.Box,
    {
      as: "span",
      w: "4px",
      ...
      children: [
        loading && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          import_react3.Box,
          {
            ...
            alignItems: "center",
            justifyContent: "center",
            children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(LoadingDots, {})
          }
        ),
        loading && loadingText && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          import_react3.Box,
          {
            as: "span",
            position: "absolute",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          import_react3.Box,
          {
            ...
            children: [
              leftIcon && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react3.Box, { as: "span", display: "inline-flex", flexShrink: 0, "aria-hidden": true, children: leftIcon }),
              children,
              rightIcon && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react3.Box, { as: "span", display: "inline-flex", flexShrink: 0, "aria-hidden": true, children: rightIcon })
            ]
          }
        )
      ]
...
function CodeBlock({ children, language }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    import_react4.Box,
    {
      ...
      overflow: "auto",
      children: [
        language && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          import_react4.Box,
          {
            as: "span",
            fontSize: "xs",
