...
| **`search()` MCP tool + dense output mode** — natural-language discovery over component descriptions and token `$description` fields, plus a token-efficient output flag for agent context windows. Unblocked — spec-doc-generated metadata landed 2026-07-13 (`mcp-builder/scripts/generate.ts`)                                                                                                                                                                                            | Low      |
